...
if(isset($_POST['submit']))
{
	...
	if($er == 0)
	{
		$sql = "update goldpackageservice set descriptionid='".$description."', trial='".$trial."', standard='".$standard."', premium='".$premium."' where id = ".$_GET['id'];
		if(mysql_query($sql))
		{
...
{
	$sql = "select * from goldpackageservice where id = ".$_GET['id'];
	$r = mysql_query($sql);
